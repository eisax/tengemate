...
CustomTextField(
                            borderRadius: Dimensions.radiusDefault,
                            hintText: 'Full Name', controller: useremail,
                            fillColor: Colors.transparent,
                            // errorText: "Please enter your email",
                            borderColor: Colors.black.withOpacity(0.5),
                          ),
                          ...
                          CustomTextField(
                            borderRadius: Dimensions.radiusDefault,
                            hintText: 'example@tengemate.com', controller: useremail,
                            fillColor: Colors.transparent,
                            inputType: TextInputType.emailAddress,
                            // errorText: "Please enter your email",
                            borderColor: Colors.black.withOpacity(0.5),
                          ...
                          CustomTextField(
                            borderRadius: Dimensions.radiusDefault,
                            hintText: 'Phone Number', controller: useremail,
                            fillColor: Colors.transparent,
                            // errorText: "Please enter your email",
                            inputType: TextInputType.phone,
                            borderColor: Colors.black.withOpacity(0.5),
                          ...
                          CustomTextField(
                            borderRadius: Dimensions.radiusDefault,
                            hintText: 'Date of birth', controller: useremail,
                            fillColor: Colors.transparent,
                            // errorText: "Please enter your email",
